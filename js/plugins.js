...
function init() {
	...
	var mapOptions = {
		...
		center: new google.maps.LatLng(12.9483899,77.7141251),	// Change to your latitude & longitude
	...
	var marker = new google.maps.Marker({
		...
		map: map,
		title: "Amal Studio"		// Change to your text
	});

	var infowindow = new google.maps.InfoWindow({
		content: "Amal Studio"		// Change to your text
	});
